...
<template>
    <div>
        <button class="btn btn-success" @click="create = true"><i class="fa fa-plus fa-first" aria-hidden="true"></i> Tambah Pelanggan</button>
        <candy-modal title="Buat Pelanggan" v-show="create" size="modal-md" @closed="create = false">
            <div slot="body">
